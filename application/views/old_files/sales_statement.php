...
<script type="text/javascript">
    $("#search_sales").click(function () {
        ...
        var user = $('#user').val();
        var post_data = {
            'date_from': date_from, 'date_to': date_to, 'product_name': product_name, 'product_category': product_category,
            'invoice': invoice, 'user': user, 'client_id': client_id, 'parts_no': parts_no,
    ...
    $("#export_excel").click(function () {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>Get_ajax_value/download_excel",
            data: post_data,
            success: function (data) {

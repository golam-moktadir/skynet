                ...
                <div>
                    ...
                    <div class="box-body table-responsive" style="width: 98%; color: black;">
                        <table id="example2" class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    <th style="text-align: center;" colspan="5">All Sales Due</th>
                                </tr>
                                <tr>
                            ...
                            <tbody>
                                ...
                                for ($i = 1; $i <= $count_it; $i++) {
                                    $total_due += ${"sales_due" . $i};
                                    ?>
                                    <tr>
                                        <td style="text-align: center;"><?php echo $i; ?></td>
                                        <td style="text-align: center;"><?php echo ${"client_name" . $i} . " [Id: " . ${"client_id" . $i} . "]"; ?></td>
                                        <td style="text-align: center;"><?php echo ${"sales_due" . $i}; ?></td>

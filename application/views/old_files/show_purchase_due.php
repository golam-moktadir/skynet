<div class="box-body table-responsive" style="width: 98%; color: black;">
    ...
    <table id="example2" class="table table-bordered table-hover">
        <thead>
            <tr>
                <th colspan="8">
                    <p style="text-align: center; font-weight: bold;">Supplier Name: <?php echo $vendor_name; ?></p>
                </th>
            </tr>
            <tr>
...
<script type="text/javascript">
    ...
    $('#pay_btn').on('click', function (e) {
        ...
        var post_data = {
            'paid': paid, 'search_vendor': search_vendor, 'final_due': final_due, 'discount': discount,

        ...
        <div class="row">
            <section class="col-xs-12 connectedSortable">
                <div class="box box-info" style="color: black;">
                    <?php echo form_open_multipart('Insert/sales_dealing'); ?>
                    <div class="box-body">
                        <p style="font-size: 20px;">Sales Dealing Info.</p>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-10 col-xs-12" style="width: 300px;">
                                ...
                                <textarea class="form-control" id="comments" rows="3"
                                        placeholder="" name="comments"></textarea>
                            </div>
                        </div>
                    </div>
                            ...
                            <tbody>
                                ...
                                foreach ($all_value as $single_value) {
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;"><?php echo $single_value->comments; ?></td>
                                        <td style="text-align: center;">
                                            <a style="margin: 5px;" class="btn btn-info fa fa-edit"
                                               href="<?php echo base_url(); ?>Show_edit_form/sales_dealing/<?php echo $single_value->record_id; ?>">
                                            </a>
                                            <a style="margin: 5px;" class="btn btn-danger fa fa-trash-o" title="Delete"
                                               href="<?php echo base_url(); ?>Delete/sales_dealing/<?php echo $single_value->record_id; ?>">
                                            </a>
                                        </td>
                                    </tr>
                                <?php } ?>

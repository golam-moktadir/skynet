...
foreach ($one_value as $one_info) {
    ...
    $due = $one_info->due;
    $paid = $one_info->paid;
    $net_payable = $one_info->net_payable;
    $total_discount = $one_info->total_discount;
    ...
    $total_price = $one_info->total_price;
...
<aside>
    <section class="content" style="padding-top: 0px; margin-top: 0px;">
            ...
            <section class="col-xs-12 connectedSortable"> 
                <?php echo form_open_multipart('Edit/purchase_product/' . $record_id); ?>
                    ...
                    <div class="box-body" style="margin-bottom: 10px;">
                        ...
                        <div class="row">
                            <div class="form-group col-sm-2 col-xs-12">
                                ...
                                <select name="machine_category" id="machine_category" class="form-control selectpicker" data-live-search=true>
                                    <option value="">--Select--</option>
                                    <?php foreach ($product_type as $info) { ?>
                                        <option <?php if($machine_category==$info->product_type) echo "selected"; ?> value="<?php echo $info->product_type; ?>">
                            ...
                            <div class="form-group col-sm-2 col-xs-12">
                                ...
                                <select name="brand" id="brand" class="form-control"
                                    ...
                                    <option <?php if($brand=="Sinotruk") echo "selected" ?> value="Sinotruk">Sinotruk</option>
                                </select>
                            </div>
                            <div class="form-group col-sm-2 col-xs-12">
                                <label for="parts_name">Parts Name</label>
                                <select name="parts_name" id="parts_name" class="form-control selectpicker" data-live-search=true>
                            ...
                            <div class="form-group col-sm-2 col-xs-12">
                                ...
                                <textarea type="text" class="form-control" id="description" rows="1"
                                           placeholder="" name="description"><?php echo $description; ?></textarea>
                            </div>
                            <div class="form-group col-sm-2 col-xs-12">
                            ...
                            <div class="form-group col-sm-2 col-xs-12">
                                <input style="margin-top: 27px" value="Edit" name="single_product" type="submit" class="pull-left btn btn-success"
                                        id="save_btn">
                            </div>
                        </div>
                        <hr>
                        <div class="row" style="margin-top:10px;">
                            <?php if(isset($po_no)): ?>
                                ...
                                <div class="form-group col-sm-2 col-xs-12">
                                    ...
                                    <input type="text" class="form-control" id="total_cost" value="<?php echo $total; ?>" placeholder="" name="total_cost" readonly>
                                </div>
                                <div class="form-group col-sm-2 col-xs-12">
...
<?php endif; ?>
<script>
    $('#machine_category').on('change paste keyup', function () {
        var product_type = $('#machine_category').val();

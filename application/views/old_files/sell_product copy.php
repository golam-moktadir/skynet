                                ...
                                foreach (${"pro_result" . $i} as $single_value) {
                                    ...
                                    <tr>
                                        <?php if ($one_time == 1) { ?>
                                            <td style="text-align: center;" rowspan="<?php echo $row_count; ?>">
                                                ...
                                                <?php  if($this->session->ses_user_type=="admin"): ?>
                                                    <a style="margin: 5px;" onclick="return confirm('Are You Sure Delete This Referance No?')" class="btn btn-danger fa fa-trash-o btn-sm"
                                                    title="Delete"
                                        ...
                                        <td style="text-align: left; white-space: nowrap;">
                                            <b>Parts Name: </b><?php echo $single_value->product_name; ?></b><br>
                                            <b>Part No: </b><?php echo $single_value->parts_no; ?></b><br />
                                            <b>Alt.Part No: </b><?php echo $single_value->alt_parts_no; ?></b>
                                        </td>
                                        ...
                                        <?php if ($one_time == 1) { ?>
                                            ...
                                            <td rowspan="<?php echo $row_count; ?>" style="text-align: center;"><?php echo $single_value->sold_by; ?></td>

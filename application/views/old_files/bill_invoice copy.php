...
<div id="invoice">
    <?php echo form_open('Edit/print_field_invoice/'); ?>
    ...
    <div id="print_div">
        <div class="box-body" style="width: 90%; color: black; padding-left: 30px">
            ...
            <p style="margin-left: 15px; text-align:left; color: black; font-size: 16px; font-family: 'Lucida Grande'">
            Reference: <span id="show_reference_invoice"><small><small></span>
            </p>
            <p style="margin-left: 15px; text-align:left; color: black; font-size: 16px; font-family: 'Lucida Grande'">
                To
            </p>
            ...
            <p style="margin-left: 15px; text-align:left; color: black; font-size: 16px; font-family: 'Lucida Grande'">
                <b>Address:</b> <span id="show_address_invoice"></span>
            </p>
            <p style="margin-left: 15px; text-align:left; color: black; font-size: 17px; font-family: 'Lucida Grande'; ">
                Project Name: <span id="show_project_name_invoice"></span>
            </p>
            <p style="margin-left: 15px; text-align:left; color: black; font-size: 17px; font-family: 'Lucida Grande';">
                Indent No/Requisition No/PO No: <span id="show_po_no_invoice"></span>
            </p>
            <p style="margin-left: 15px; text-align:left; color: black; font-size: 17px; font-family: 'Lucida Grande';">
            Machine Category/Model: <span id="show_mpr_invoice"></span>
            </p>
            ...
            <table class="table table-bordered table-hover" style="margin: 20px; width: 100%; font-size:14px;">
                ...
                <?php $i=1; ?>
                    ...
                    <tr>
                        <td style="text-align: center;  font-size: 17px;" colspan="11"><b>In Word: <?= @$sub_total;?> Only</td>
...
<script type="text/javascript">
    $("#reference_invoice, #address_invoice, #project_name_invoice, #po_no_invoice, #mpr_invoice,#currency").on("change paste keyup", function () {
